...
Provides an in-app AI assistant chat panel powered by the Groq API. Users can converse with the assistant, which receives the user's active tasks as context. All API communication is handled server-side to keep the API key secure.
