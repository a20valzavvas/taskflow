...
Core task management capabilities for TaskFlow. Users can create, complete, delete, and filter tasks. Tasks are persisted to localStorage so they survive page reloads.
