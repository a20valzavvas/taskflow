...
Allows users to switch between color palettes (earthy and rose) and persists their preference across sessions. Theme initialization is SSR-safe to avoid hydration errors.
